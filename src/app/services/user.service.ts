      ...
      .subscribe(res => {
        if (res.success) {
          ...
          this.bulkSmsService.sendMessageWithSubscribe(
            '88' + data.phoneNo,
            `Dear ${data.fullName}, Welcome to Esquire Electronics. Enjoy authentic home appliances at country’s most trusted electronics store support@gadgetex.com.bd. Hotline: 8809610001010.`
          );
        } else {
